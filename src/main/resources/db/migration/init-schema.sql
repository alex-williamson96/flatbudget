...
-- );
--
-- CREATE TABLE budget_budget_table_list
-- (
--     budget_budget_id     BIGINT NOT NULL,
--     budget_table_list_id BIGINT NOT NULL
-- );
--
...
--     updated_date     TIMESTAMP WITHOUT TIME ZONE,
--     notes            VARCHAR(255),
--     CONSTRAINT pk_budgettable PRIMARY KEY (id)
-- );
--
-- CREATE TABLE budget_table_category_list
-- (
--     budget_table_id  BIGINT NOT NULL,
...
-- );
--
-- CREATE TABLE category_transaction_list
-- (
...
-- );
--
-- CREATE TABLE payee_transaction_list
-- (
...
-- );
--
-- CREATE TABLE user_profile_payee_list
-- (
--     user_user_id  BIGINT NOT NULL,
--     payee_list_id BIGINT NOT NULL
-- );
--
-- CREATE TABLE user_profile_transaction_list
-- (
--     user_user_id        BIGINT NOT NULL,
--     transaction_list_id BIGINT NOT NULL
-- );
